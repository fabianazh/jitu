    ...
    return (
        <>
            <button
                ...
                className={`block w-full z-50 rounded font-medium px-4 py-2 text-start text-xs lg:text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition-all duration-200 ease-in-out ${className} ${
                    active ? 'bg-stone-100/80 hover:bg-stone-200' : ''
                }`}
            >
                {children}
